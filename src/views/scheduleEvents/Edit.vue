...
<template>
    ...
    <UiParentCard v-if="!isLoading && scheduleEvent !== null">
        ...
        <v-col cols="12" md="6">
            <v-label class="text-subtitle-1 font-weight-semibold text-lightText">Quantidade de Vagas:</v-label>
            <v-text-field v-model="scheduleEvent.occupancy"></v-text-field>
        </v-col>
        <v-col cols="12" md="6">
            <v-label class="text-subtitle-1 font-weight-semibold text-lightText">Dia da Semana:</v-label>
            <v-text-field v-model="scheduleEvent.dayOfWeek"></v-text-field>
        </v-col>
        <v-col cols="12" md="6">
            <v-label class="text-subtitle-1 font-weight-semibold text-lightText">Frequência:</v-label>
