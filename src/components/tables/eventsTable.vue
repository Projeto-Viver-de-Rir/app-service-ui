            ...
            <tbody>
                <tr v-for="item in events" :key="item.id" class="month-item">
                    ...
                    <td>
                        <div class="d-left">
                              <div>
                                <h6 class="text-h6">{{ new Date(item.happenAt).toLocaleDateString() + " " + new Date(item.happenAt).getHours() + ":"+ (new Date(item.happenAt).getMinutes() < 10 ? '0' : '') + new Date(item.happenAt).getMinutes() }}</h6>
                            </div>
                        </div>
                    </td>
<td>
