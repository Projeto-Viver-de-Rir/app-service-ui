            ...
            <tbody>
                <tr v-for="item in debts" :key="item.id" class="month-item">
                    ...
                    <td>
                        <div class="d-left">
                              <div>
                                <h6 class="text-h6">{{ new Date(item.dueDate).toLocaleDateString() }}</h6>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="d-left">
                              <div>
                                <h6 v-if="item.paidAt !== null" class="text-h6">{{ new Date(item.paidAt).toLocaleDateString() }}</h6>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="d-flex align-right">
                            <div class="ml-4" style="width: 50px;">
                                <v-btn size="small" v-if="item.paidAt == null" style="margin-right: 5px;" @click="openModalPayment(item)" color="success" type="submit">Pagar</v-btn>                               
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="d-flex align-right">
                            <div class="ml-4" style="width: 100px;">
                                ...
                                >
                                    ...
                                    <v-btn size="small" color="primary" type="submit">Editar</v-btn>
                                </router-link>                                
                            </div>
                        </div>
                    </td>
