...
const save = async () => {
    if (availability.value) formData.availability = availability.value.toString();
    ...
    <v-form>
        <h5 class="text-h5">Dados pessoais</h5>
            ...
            <div class="mt-5">
                ...
                <v-row>
                    <v-col cols="12"><span class="mb-2 font-weight-medium">Disponibilidade:</span></v-col>
                    <v-col v-for="day in weekDays" :key="day.key">
                        <v-checkbox
