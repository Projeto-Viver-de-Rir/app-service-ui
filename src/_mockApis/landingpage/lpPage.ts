...
const userReview: UserReviewTypes[] = [
  {
    ...
    review:
      'Ser voluntário, utilizando a figura do Palhaço transforma o ambiente em que estamos e leva o outro a perceber, que por meio do "ridículo" os erros não devem ser escondidos, mas revelados, nos levando a aceitação de quem somos e como estamos... É um sensação extraordinária, conseguir fazer com que o outro se sinta bem através de um simples sorriso.',
  },
  {
    img: review1,
    ...
    review:
      "Fazer parte da ONG Viver de Rir, e poder transmitir um pouco de atenção, uma brincadeira, um sorriso, ou até mesmo um simples olhar, faz com que tudo na vida valha a pena. E a retribuição e o reconhecimento de nossa presença a cada visita, alimenta nossa alma...",
  },
  {
    img: review2,
  ...
  },
  {
    ...
    review:
      "Ser voluntário é despertar o sentimento de empatia,compaixão e sensibilidade. Fazer parte da ong Viver de Rir é compartilhar amor, sendo isso gratificante e recompensador. O bem que é doado tem 100% de retorno.",
  },
];
